...
class ProductController {
  ...
  Future<APIResponse<Product>> listarProdutos() {
    return http.get(Uri.https(EnvironmentConfig.urlsConfig(), "api/produtos"), headers: {HttpHeaders.contentTypeHeader: "application/json", HttpHeaders.authorizationHeader: "Bearer ${Util.getToken()}"}).then((data) {
